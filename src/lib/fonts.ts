...
const playfairDisplay = Playfair_Display({ subsets: ["latin"], variable: "--font-playfair-display", display: "swap", preload: false })
const cormorantGaramond = Cormorant_Garamond({ subsets: ["latin"], weight: ["400", "500", "600", "700"], variable: "--font-cormorant-garamond", display: "swap", preload: false })
const cormorant = Cormorant({ subsets: ["latin"], weight: ["400", "500", "600", "700"], variable: "--font-cormorant", display: "swap", preload: false })
const libreBaskerville = Libre_Baskerville({ subsets: ["latin"], weight: ["400", "700"], variable: "--font-libre-baskerville", display: "swap", preload: false })
const dmSerifDisplay = DM_Serif_Display({ subsets: ["latin"], weight: "400", variable: "--font-dm-serif-display", display: "swap", preload: false })
const bodoniModa = Bodoni_Moda({ subsets: ["latin"], variable: "--font-bodoni-moda", display: "swap", preload: false })
...
const libreCaslonDisplay = Libre_Caslon_Display({ subsets: ["latin"], weight: "400", variable: "--font-libre-caslon-display", display: "swap", preload: false })

const inter = Inter({ subsets: ["latin"], variable: "--font-inter", display: "swap", preload: false })
const dmSans = DM_Sans({ subsets: ["latin"], variable: "--font-dm-sans-selectable", display: "swap", preload: false })
...
const allura = Allura({ subsets: ["latin"], weight: "400", variable: "--font-allura", display: "swap", preload: false })
